...
def app(m, p):
    ...
    if start_building is None or end_building is None:
        st.header("Please select both start and end buildings.")
    elif start_building == end_building:
        st.header("You are already at your destination!")
    else:
        ...
        st.header('Here is the best path to reach your destination:')
